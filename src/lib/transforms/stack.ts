...
import type { BaseMarkStyleProps, ChannelAccessor, ChannelName, DataRow, DataRecord, TransformArg } from '$lib/types.js';
...
function stackXY(byDim: 'x'|'y', data: DataRow[], channels: Partial<Record<ChannelName, ChannelAccessor>>, options: StackOptions) {
...
export function stackX({ data, ...channels }: TransformArg, opts: Partial<StackOptions> = {}): TransformArg {
