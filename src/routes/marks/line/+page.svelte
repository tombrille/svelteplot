<script lang="ts">
    ...
    import type { Curve, Datasets } from '$lib/types.js';
...
<div class="content">
    ...
    <p class="block">
        Similarily, you can use <b>LineX</b> mark to quickly plot an array of numbers as lines, but the
    ...
    <p>
        You can control the interpolation curve using the <b>curve</b> and <b>tension</b> options:
    </p>
