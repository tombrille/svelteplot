...
For the positional channels such as x, x1, or y, Plot assumes that you'll always want to map the values to a scale, no matter how they're specified. In the following example.
